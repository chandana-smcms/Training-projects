...
public class Demo_Computers_Page {
	...
	/*
	 * By
	 * desktops=By.xpath("//ul[@class='top-menu']//a[contains(text(),'Desktops')]");
	 */
	 ...
	 * "//div[@class='master-wrapper-content']//div[1]//div[1]//div[2]//div[3]//div[2]//input[1]"
	 * );
	 */
	...
	public void addToCart() throws IOException, InterruptedException 
	{
	    ...
	    driver.findElement(buildcheapcomp).click();
