...
public class Demo_Register_Page {
	...
	public void registerPage() //using webdriver get visting the testing website
	{
	...
	public void registerDetails() throws IOException, InterruptedException 
	{
		...
		driver.findElement(registerlink).click(); // clicking on registerlink
		driver.findElement(radiofemale).click();//clicking on radio button
		driver.findElement(firstname).sendKeys("chandana");//entering the firstname
		driver.findElement(lastname).sendKeys("surendra");//entering last name
		driver.findElement(email).sendKeys("chandana1422@gmail.com");;//enter the valid email 
	...
	public void registerInvalidDetails() throws IOException, InterruptedException 
	{
		...
		driver.findElement(password).sendKeys("chandu 007!"); // enter the vaild password
		driver.findElement(confirmpassword).sendKeys("chandu 007!");//confirm password
